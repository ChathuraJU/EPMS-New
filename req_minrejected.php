                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="primapp" data-placeholder="Pending" class="select-search required">
                                                <option></option> 
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="procuretype" data-placeholder="Direct/Indirect" class="select-search required">
                                                <option></option> 
