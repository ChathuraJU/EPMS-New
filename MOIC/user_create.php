            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    <div class="text-right">
                        <a id="bbbsave" class="btn btn-primary">Submit form <i class="icon-arrow-right14 position-right"></i></a>
                    </div>
                </div>
            </div>
        </form>
    ...
    <script>
        ...
        function mydatatable(){
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    method: "POST",
                    url: "../DBhandle/user_manage_con.php?code=get_empidselect_data",
                    processData: false,
                    contentType: false
                })
                    .done(function (data) {
                ...
                $.ajax({
                    method: "POST",
                    url: "../DBhandle/user_manage_con.php?code=get_utypeselect_data",
                    processData: false,
                    contentType: false
                })
                    .done(function (data) {
