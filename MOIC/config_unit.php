...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active"> Create / Manage Unit
        </div>
    </div>
    <!-- /page header -->
    ...
    <script>
        ...
        sendData = new FormData($("#unitcreateform")[0]);
            ...
            $.ajax({
                method: "POST",
                url: "../DBhandle/config_unitlist_con.php?code=get_uheadidselect_data",
                processData: false,
                contentType: false
            })
                .done(function (data) {
            ...
            $.ajax({
                method: "POST",
                url: "../DBhandle/config_unitlist_con.php?code=get_uheadnameselect_data",
                processData: false,
                contentType: false
            })
                .done(function (data) {
            ...
            $.ajax({
                method: "POST",
                url: "../DBhandle/config_unitlist_con.php?code=get_data",
                processData: false,
                contentType: false
            })
                .done(function (data) {
