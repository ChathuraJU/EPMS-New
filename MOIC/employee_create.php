                            ...
                            <div class="col-md-6">
                                <div class="form-group">
									...
									<label class="radio-inline radio-right">
										<input type="radio" name="morf" class="styled" checked="checked">
										Male
									</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="dob" name="dob" class="form-control pickadate-strings required" placeholder="Try me&hellip;">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="content-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="icon-calendar5"></i></span>
                                                <input type="text" id="djoin" name="djoin" class="form-control pickadate-strings required" placeholder="Try me&hellip;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
