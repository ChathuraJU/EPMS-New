...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active"> Fund Allocations</li>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <form id="equipcreateform" class="form-horizontal" action="#">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h5 class="panel-title"><b>Allocate Funds</b></h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                ...
                <div class="panel-body">
                    <fieldset>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Procurement ID :</label>
                                    <div class="col-lg-9">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" id="eqpno" name="eqpno" class="form-control required" >    
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Funded Via :</label>
                                    <div class="col-lg-9">
                                    <select id="fundvia" name="fundvia" data-placeholder="Select the source of funds" class="select required">
                                        <option></option> 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Funded Amount :</label>
                                    <div class="col-lg-9">
                                        <input type="text" id="fundamt" name="fundamt" class="form-control required" >    
                                    </div> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label"> Funded By : </label>
                                    <div class="col-lg-9">
                                        <input type="text" id="fundby" name="fundby" class="form-control required" >    
                                    </div> 
                                </div>
                            </div>
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h5 class="panel-title"> <b> Fund Allocation List </b></h5>
                <div class="heading-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                        <li><a data-action="reload"></a></li>
