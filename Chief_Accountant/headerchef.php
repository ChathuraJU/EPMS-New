<?php 
    session_start();
    if(!isset($_SESSION["user"]) || $_SESSION["user"]["utype"]!="Chief Accountant"){
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="dashboardchef.php"><img src="../global_assets/images/logo_light.png" alt=""></a>
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								...
								<div class="media-body">
									<span class="media-heading text-semibold"> Chief Accountant </span>
									<div class="text-size-mini text-muted">
										<i class="icon-office text-size-small"></i> &nbsp;Finance Unit, National Hospital Kandy
									</div>
								</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- Dashboard -->
								<li><a href="dashboardchef.php"><i class="icon-home4"></i> <span>Dashboard</span></a>
									<ul>
