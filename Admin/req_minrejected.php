...
<div class="content-wrapper" id="content">
    ...
    <div class="content">
        ...
        <div class="panel panel-info">
            ...
            <table id="minrej" class="table datatable-responsive-control-right">
                <thead>
                    <tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "POST",
                url: "../DBhandle/update_minapp_con.php?code=get_rejdata",
                processData: false,
                contentType: false
            })
                .done(function (data) {
                    $('#minrej').DataTable().destroy();
                    $('#minrej tbody').empty();
                    $('#minrej tbody').append(data);
                    mydatatable();
                });
        });
