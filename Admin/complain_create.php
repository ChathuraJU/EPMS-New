            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Equipment Code :<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" id="eqpcode" name="eqpcode" class="form-control required"  >
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <script>
        ...
        sendData = new FormData($("#complaincreateform")[0]);
                ...
                $.ajax({
                    ...
                    swal({
                            title: "Complain Recorded Successfully!",
