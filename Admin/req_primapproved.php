    ...
    <div class="content-wrapper" id="content">
        ...
        <div class="content">
            ...
            <div class="panel panel-info">
                ...
                <table id="pappeqp" class="table datatable-responsive-control-right">
                    <thead>
                        <tr>
                            <th>Primal Approved Equipment ID </a></th>
        ...
        //get data to the table
            ...
            function getdatatotable(){
                ...
                $.ajax({
                    method: "POST",
                    url: "../DBhandle/req_primapproved_con.php?code=get_data",
                    processData: false,
                    contentType: false
                })
                    .done(function (data) {
                        $('#pappeqp').DataTable().destroy();
                        $('#pappeqp tbody').empty();
                        $('#pappeqp tbody').append(data);
                        mydatatable();
                    });
