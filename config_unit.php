...
<div class="content-wrapper">
    ...
    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="uno" name="uno" class="form-control required" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control required" placeholder="ex : Block A"> 
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h5 class="panel-title"> <b> Units List</b></h5>
                <div class="heading-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                        <li><a data-action="reload"></a></li>
